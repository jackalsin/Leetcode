package hulu._863_All_Nodes_Distance_K_in_Binary_Tree;
...
class SolutionITest {
  ...
  @ParameterizedTest
  @MethodSource("solutionStream")
  void testOnlineCaseLeaf2(Solution solution) {
    final TreeNode root = TreeNodes.getTreeLevelOrder(0, 2, 1, null, null, 3);
    final List<Integer> actual = solution.distanceK(root, root.right.left, 3);
