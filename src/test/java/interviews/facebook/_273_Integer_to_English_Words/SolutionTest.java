package interviews.facebook._273_Integer_to_English_Words;
...
class SolutionTest {
  ...
  void testOnlineCase1() {
    assertEquals("One Hundred Twenty Seven", Solution.getThousand(127));
  }

  @Test
  void testOnlineCase2() {
    assertEquals("Two Hundred", Solution.getThousand(200));
  }
}