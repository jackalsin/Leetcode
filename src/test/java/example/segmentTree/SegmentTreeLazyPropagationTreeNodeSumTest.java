...
class SegmentTreeLazyPropagationTreeNodeSumTest {
  ...
  void testOnline() {
    ...
    solution = new SegmentTreeLazyPropagationTreeNode(nums);
  ...
  /**
   * ["SegmentTreeArraySolution","update","update","update","sumRange","update","sumRange","update","sumRange",
   * "sumRange","update"]
  ...
  void testFailed1() {
    ...
    solution = new SegmentTreeLazyPropagationTreeNode(input);
    solution.update(4, 6);
    solution.update(0, 2);
    solution.update(0, 9);
