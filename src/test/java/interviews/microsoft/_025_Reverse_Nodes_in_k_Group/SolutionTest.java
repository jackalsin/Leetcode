package interviews.microsoft._025_Reverse_Nodes_in_k_Group;
...
class SolutionTest {
  ...
  @Test
  void testWithK2() {
    final int[] input = {1, 2, 3, 4, 5}, expected = {2, 1, 4, 3, 5};
    final ListNode inputNode = ListNodes.getListOfNodes(input),
        expectedNode = ListNodes.getListOfNodes(expected);
    assertEquals(expectedNode, solution.reverseKGroup(inputNode, 2));
  }
