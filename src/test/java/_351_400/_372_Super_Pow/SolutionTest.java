...
class SolutionTest {
  ...
  void testOnlineCase1() {
    final int[] b = {1, 0};
    assertEquals(1024, solution.superPow(2, b));
  }

  @Test
  void testOnlineCase2() {
    final int[] b = {3};
    assertEquals(8, solution.superPow(2, b));
  }
