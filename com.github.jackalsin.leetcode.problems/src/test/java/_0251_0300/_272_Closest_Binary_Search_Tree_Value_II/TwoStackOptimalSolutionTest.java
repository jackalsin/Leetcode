...
class TwoStackOptimalSolutionTest {
  private Solution solution;

  @BeforeEach
  void setUp() {
    solution = new TwoStackOptimalSolution();
  }
  ...
  void testFailedCase3() {
    final TreeNode root = TreeNodes.getTreeLevelOrder(4, 2, 5, 1, 3);
    final List<Integer> expected = List.of(5, 4, 3);
    assertEquals(expected, solution.closestKValues(root, 4.857143, 3));
  }
}