...
public class SolutionTest {
  ...
  public void testOnlineCase() throws Exception {
    ListNode input = ListNodes.getListOfNodes(new int[] {1, 4, 3, 2, 5, 2});
    ListNode expected = ListNodes.getListOfNodes(new int[] {1, 2, 2, 4, 3, 5});
  ...
  public void test3And1() throws Exception {
    ListNode input = ListNodes.getListOfNodes(new int[] {3, 1});
    ListNode expected = ListNodes.getListOfNodes(new int[] {1, 3});
    assertEquals(expected, solution.partition(input, 2));
  }
