package microsoft._008_String_to_Integer_atoi;
...
class SolutionTest {
  ...
  @Test
  void testDownOverflow() throws Exception {
    assertEquals(Integer.MIN_VALUE, solution.myAtoi(String.valueOf("-91283472332")));
  }
}