package interviews.microsoft.noodleEssence._468_Validate_IP_Address;
...
class SolutionTest {
  ...
  @Test
  void testFailedCase2IPv4() {
    final String ip = "12..33.4";
    assertEquals(NEITHER, solution.validIPAddress(ip));
  }
