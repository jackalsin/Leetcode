...
class SolutionTest {
  ...
  @ParameterizedTest
  @MethodSource("solutionStream")
  void testWith5by5(Solution solution) {
  ...
  @ParameterizedTest
  @MethodSource("solutionStream")
  void testWith4by4(Solution solution) {
  ...
  @ParameterizedTest
  @MethodSource("solutionStream")
  void testWith1by2(Solution solution) {
  ...
  @ParameterizedTest
  @MethodSource("solutionStream")
  void testWith2by3(Solution solution) {
    assertEquals(Arrays.asList(2, 5, 8, -1, 0, 4),
        solution.spiralOrder(new int[][]{{2, 5, 8}, {4, 0, -1}}));
  }
